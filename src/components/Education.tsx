            ...
            <div className="container mx-auto px-4 md:px-8">
                ...
                <div className="max-w-4xl mx-auto space-y-8">
                    {education.map((edu, index) => (
                        ...
                        >
                            <div className="shrink-0 bg-violet-500/10 p-4 rounded-lg">
                            ...
                            <div className="shrink-0 flex items-center gap-2 text-slate-500 bg-slate-900/50 px-4 py-2 rounded-full border border-slate-800">
